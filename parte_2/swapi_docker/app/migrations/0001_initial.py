# Generated by Django 2.2.13 on 2022-01-23 19:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hair_color', models.CharField(blank=True, choices=[('white', 'WHITE'), ('blonde', 'BLONDE'), ('none', 'NONE'), ('bald', 'BALD'), ('brown', 'BROWN'), ('black', 'BLACK'), ('red', 'RED')], max_length=32)),
                ('skin_color', models.CharField(blank=True, max_length=32)),
                ('eye_color', models.CharField(blank=True, choices=[('white', 'WHITE'), ('purple', 'PURPLE'), ('yellow', 'YELLOW'), ('unknown', 'UNKNOWN'), ('blue', 'BLUE'), ('brown', 'BROWN'), ('black', 'BLACK'), ('green', 'GREEN'), ('red', 'RED')], max_length=32)),
