# Generated by Django 2.2.13 on 2022-01-23 21:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hair_color', models.CharField(blank=True, choices=[('none', 'NONE'), ('red', 'RED'), ('white', 'WHITE'), ('bald', 'BALD'), ('black', 'BLACK'), ('blonde', 'BLONDE'), ('brown', 'BROWN')], max_length=32)),
                ('skin_color', models.CharField(blank=True, max_length=32)),
                ('eye_color', models.CharField(blank=True, choices=[('unknown', 'UNKNOWN'), ('red', 'RED'), ('white', 'WHITE'), ('purple', 'PURPLE'), ('black', 'BLACK'), ('blue', 'BLUE'), ('yellow', 'YELLOW'), ('brown', 'BROWN'), ('green', 'GREEN')], max_length=32)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('skin_color', models.CharField(blank=True, max_length=32)),
                ('birth_year', models.CharField(blank=True, max_length=16)),
                ('films', models.ManyToManyField(blank=True, related_name='films_character', to='app.Film')),
            ],
            options={
